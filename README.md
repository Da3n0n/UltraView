...
`Ultraview: Open Ports &amp;amp;amp;amp;amp; Processes`
...
- **View ports &amp; processes** — open the Ports &amp; Processes sidebar or run `Ultraview: Open Ports &amp;amp;amp;amp;amp; Processes` to bring it up as a full‑width panel
