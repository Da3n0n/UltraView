...
This project is indexed by GitNexus as **Ultraview** (3349 symbols, 8781 relationships, 281 execution flows).
...
`gitnexus://repo/Ultraview/context`

Codebase overview, check index freshness

`gitnexus://repo/Ultraview/clusters`

All functional areas

`gitnexus://repo/Ultraview/processes`

All execution flows

`gitnexus://repo/Ultraview/process/{name}`
...
This project is indexed by GitNexus as **Ultraview** (3358 symbols, 8795 relationships, 284 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/Ultraview/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Ultraview/clusters` | All functional areas |
| `gitnexus://repo/Ultraview/processes` | All execution flows |
| `gitnexus://repo/Ultraview/process/{name}` | Step-by-step execution trace |
