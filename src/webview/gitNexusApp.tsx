...
function App(): React.ReactElement {
    ...
    return <div className="shell">
        ...
        <div className="body">
            <main>
                {!status.running && <div className="empty"><div className="orb">⌘</div><h2>Local code intelligence</h2><p>Start GitNexus to explore symbols, dependencies, execution flows and impact—all on this machine.</p><button className="primary large" onClick={() => send('start')}>Install & start GitNexus</button><small>Requires Node.js 22.18+ or 24.11+</small></div>}
